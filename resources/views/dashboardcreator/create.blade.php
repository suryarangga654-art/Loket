<x-app-layout>
    <style>
        /* Menggunakan x-cloak agar transisi Alpine.js halus */
        ...
        .card-stat { @apply bg-white border-2 border-gray-100 rounded-2xl p-6 shadow-sm flex flex-col transition-all hover:border-blue-200; }
    </style>
    ...
    <div class="bg-gray-50 flex min-h-screen" x-data="{ role: 'creator', view: 'event' }">
        ...
        <aside class="w-64 bg-[#1a2b4c] text-gray-300 flex flex-col sticky top-0 h-screen shadow-xl z-30">
            ...
            <nav class="flex-1 overflow-y-auto flex flex-col">
                <div x-show="role === 'creator'" class="flex flex-col">
                    <div class="px-6 py-2 text-[10px] uppercase font-bold text-gray-500 tracking-widest">Dashboard</div>
                    
                    <a href="{{ route('dashboardcreator.create')}}" class="flex items-center px-6 py-3 text-sm text-white bg-blue-600 border-l-4 border-blue-400 font-semibold transition-all">
                ...
                <div class="mt-auto pb-6">
                    ...
                    <button @click="role = (role === 'pembeli' ? 'creator' : 'pembeli')" 
                            class="w-full flex items-center px-6 py-3 text-sm text-gray-400 border-l-4 border-transparent hover:text-blue-400 group transition-all text-left">
        ...
        <main class="flex-1 flex flex-col min-w-0">
            <header class="h-16 bg-white border-b flex items-center justify-between px-8 sticky top-0 z-20 shadow-sm">
                <h2 class="text-lg font-bold text-gray-700 uppercase italic tracking-tighter" x-text="role === 'creator' ? 'Event Saya' : 'Tiket Saya'"></h2>
            ...
            <div class="p-8">
                ...
                <div x-show="role === 'creator'" x-cloak x-transition:enter="duration-300 ease-out" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="card-stat min-h-[140px]">
                            <div class="flex justify-between items-start">
                                ...
                                <span class="text-orange-500 text-[10px] font-bold cursor-pointer hover:underline uppercase italic">Detail</span>
                            </div>
                ...
                <div x-show="role === 'pembeli'" x-cloak x-transition:enter="duration-300 ease-out">
