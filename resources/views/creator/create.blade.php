...
<footer class="bg-blue-900 text-white pt-16 pb-8 px-16 w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
    ...
    <div class="pt-8 border-t border-blue-800 flex flex-col md:flex-row justify-between items-center gap-6">
